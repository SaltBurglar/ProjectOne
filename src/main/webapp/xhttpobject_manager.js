window.onload = function(){ //this is essentially a callback function for the window's completion signal
    selectAllReimbursements();
    document.getElementById("all").addEventListener('click', selectAllReimbursements);
    document.getElementById("unresolved").addEventListener('click', selectAllUnresolved);
    document.getElementById("approved").addEventListener('click', selectAllApproved);
    document.getElementById("rejected").addEventListener('click', selectAllRejected);
    document.getElementById("myStatusSubmit").addEventListener('click', handleForm("myStatusSubmit"));

}

function selectAllReimbursements(){
    ...
    xhttp.open('GET', 'http://localhost:9001/ProjectOne/manager/view_all_reimbursements/');
...
function selectAllUnresolved(){
    ...
    xhttp.open('GET', 'http://localhost:9001/ProjectOne/manager/view_all_reimbursements/unresolved');
...
function selectAllApproved(){
    ...
    xhttp.open('GET', 'http://localhost:9001/ProjectOne/manager/view_all_reimbursements/approved');
...
function selectAllRejected(){
    ...
    xhttp.open('GET', 'http://localhost:9001/ProjectOne/manager/view_all_reimbursements/rejected');
